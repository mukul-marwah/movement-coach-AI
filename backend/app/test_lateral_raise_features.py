from analysis.features import extract_lateral_raise_features
...
features = extract_lateral_raise_features(movement_data)
expected_features = {
    "left_shoulder_angle",
...
print("Lateral raise feature test: PASS")
